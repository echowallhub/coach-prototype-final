...
export class Login extends React.Component {
            ...
            <div className="form-page__wrapper" style={style.page__wrapper}>
                ...
                <div className="form-page__form-wrapper" style={style.form_wrapper}>
                    ...
                    <div className="form-page__form-header" style={style.form_header}>
                        <h2 className="form-page__form-heading" style={style.form_heading}>Login Page</h2>
    ...
    _create() {
        ...
        return $.ajax({
            url: 'http://dev.syudo.site/auth/login',
            type: 'post',
            data: {
    ...
    _onSuccess(data) {
        ...
        if(data.is_success){
            ...
            cookie.save('id', data.account_info._id);
            cookie.save('role',data.account_info.role);
            cookie.save('user_name',data.account_info.user_name);
            cookie.save('login','true');
            cookie.save('user', data.account_info);

            console.log(cookie.load('user'));

            console.log('before browser push');
            this.props.router.push('/tutorialList');
            console.log('after browser push');
        }else{
